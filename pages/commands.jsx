      ...
      {selectedCommand && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="max-w-3xl w-full mx-4 my-6 bg-white shadow-md rounded-md p-8">
            ...
            <p className="text-gray-600">{selectedCommand               <button className="absolute right-4 top-4 text-gray-400 hover:text-gray-800 transition duration-200" onClick={() => setSelectedCommand(null)}>
