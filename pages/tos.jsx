  ...
  return (
    <div>
      ...
      <div className="animateHeader text-white text-opacity-40 mt-5">
        <h2 className="mt-4 text-white font-bold text-3xl">User Agreement</h2>
        <p>
        ...
        <p>
          Through inviting the bot, it may collect specific data as described in its Policy. The intended usage of this data is for core functionalities of the bot, such as command handling, guild-specific settings, and the Welcoming System.
        </p>
        ...
        <div className="py-3"></div>
        <h2 className="mt-4 text-white font-bold text-3xl">Affiliation</h2>
        <p>
        ...
        <p>
          ...
          <a className="text-white" href="https://top.gg/bot/924325576095973426/vote">
            official Support Discord
          </a>{" "}
          of the Bot. If the above-mentioned Discord Support Server

 is not available, please DM DEVANSH#4075 on Discord.
        </p>
      </div>
    </div>
  );
