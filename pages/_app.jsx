...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/JaNCZvPxMQ",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/oauth2/authorize?client_id=1016392200516550736&permissions=2146958591&scope=bot%20applications.commands",
    },
       {
      link: true,
      name: "Vote",
      ...
      href: "https://top.gg/bot/1016392200516550736/vote",
    },
    {
      link: true,
      name: "Partners",
